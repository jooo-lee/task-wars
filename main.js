...
;// CONCATENATED MODULE: ./src/js/dom/components/dialog.js
...
;// CONCATENATED MODULE: ./src/js/dom/components/modal.js
...
;// CONCATENATED MODULE: ./src/js/dom/components/todoDetailsModal.js
...
/* harmony default export */ const components_todoDetailsModal = (createTodoDetailsModal);

;// CONCATENATED MODULE: ./src/js/dom/components/todoDetailsBtn.js
...
function createTodoDetailsBtn(todo) {
    ...
    todoDetailsBtn.addEventListener("click", function () {
        const todoDetailsModal = components_todoDetailsModal(todo);
...
/* harmony default export */ const components_todoDetailsBtn = (createTodoDetailsBtn);

;// CONCATENATED MODULE: ./src/assets/trash-can.svg
const trash_can_namespaceObject = __webpack_require__.p + "assets/bcf8d6ff346603c8a51a.svg";
;// CONCATENATED MODULE: ./src/js/dom/components/deleteTodoBtn.js
...
function createDeleteTodoBtn(currentUser, todo, project) {
    ...
    trashCan.src = trash_can_namespaceObject;
...
/* harmony default export */ const components_deleteTodoBtn = (createDeleteTodoBtn);
...
;// CONCATENATED MODULE: ./src/js/dom/components/todoForm.js
...
/* harmony default export */ const todoForm = (createTodoForm);

;// CONCATENATED MODULE: ./src/js/dom/components/editTodoForm.js
...
/* harmony default export */ const components_editTodoForm = (createEditTodoForm);

;// CONCATENATED MODULE: ./src/js/dom/components/editTodoModal.js
...
function createEditTodoModal(currentUser, todo, project) {
    ...
    const editTodoForm = components_editTodoForm(currentUser, todo, project);
    editTodoModal.appendChild(editTodoForm);

    return editTodoModal;
}

/* harmony default export */ const components_editTodoModal = (createEditTodoModal);

;// CONCATENATED MODULE: ./src/assets/square-edit.svg
const square_edit_namespaceObject = __webpack_require__.p + "assets/8421b7fc701a0f1a93be.svg";
;// CONCATENATED MODULE: ./src/js/dom/components/editTodoBtn.js
...
function createEditTodoBtn(currentUser, todo, project) {
    ...
    squareEdit.src = square_edit_namespaceObject;
    squareEdit.classList.add("square-edit-img");
    squareEdit.alt = "Edit todo";
    editTodoBtn.appendChild(squareEdit);

    editTodoBtn.addEventListener("click", () => {
        const editTodoModal = components_editTodoModal(currentUser, todo, project);
...
/* harmony default export */ const components_editTodoBtn = (createEditTodoBtn);

;// CONCATENATED MODULE: ./src/js/dom/components/todoListItem.js
...
function createTodoListItem(currentUser, todo, project) {
    ...
    const todoDetailsBtn = components_todoDetailsBtn(todo);
    todoBtnsContainer.appendChild(todoDetailsBtn);

    const editTodoBtn = components_editTodoBtn(currentUser, todo, project);
...
;// CONCATENATED MODULE: ./src/js/dom/components/listOfTodos.js
...
/* harmony default export */ const listOfTodos = (createListOfTodos);
...
;// CONCATENATED MODULE: ./src/js/dom/components/newTodoForm.js
...
function addNewTodo(currentUser, project) {
    ...
    const todoListItem = components_todoListItem(currentUser, newTodo, project);
...
/* harmony default export */ const components_newTodoForm = (createNewTodoForm);

;// CONCATENATED MODULE: ./src/js/dom/components/newTodoModal.js
...
function createNewTodoModal(currentUser, project) {
    ...
    const newTodoForm = components_newTodoForm(currentUser, project);
    newTodoModal.appendChild(newTodoForm);

    return newTodoModal;
}

/* harmony default export */ const components_newTodoModal = (createNewTodoModal);

;// CONCATENATED MODULE: ./src/js/dom/components/newTodoBtn.js
...
function createNewTodoBtn(currentUser, project) {
    ...
    newTodoBtn.addEventListener("click", () => {
        const newTodoModal = components_newTodoModal(currentUser, project);
...
/* harmony default export */ const components_newTodoBtn = (createNewTodoBtn);

;// CONCATENATED MODULE: ./src/js/dom/loadProject.js
...
function loadProject(currentUser, project) {
    ...
    const todosOfProject = listOfTodos(currentUser, project);
    main.appendChild(todosOfProject);

    const newTodoBtn = components_newTodoBtn(currentUser, project);
    main.appendChild(newTodoBtn);
}



;// CONCATENATED MODULE: ./src/js/dom/components/deleteProjectBtn.js
...
/* harmony default export */ const components_deleteProjectBtn = (createDeleteProjectBtn);

;// CONCATENATED MODULE: ./src/js/dom/components/projectListItem.js
...
function createProjectListItem(currentUser, project) {
    ...
    const deleteProjectBtn = components_deleteProjectBtn(currentUser, project);
    projectListItem.appendChild(deleteProjectBtn);

    return projectListItem;
}

/* harmony default export */ const components_projectListItem = (createProjectListItem);

;// CONCATENATED MODULE: ./src/js/dom/components/newProjectForm.js
...
function addNewProject(currentUser, projectTitle) {
    ...
    const projectListItem = components_projectListItem(currentUser, newProject);
...
/* harmony default export */ const components_newProjectForm = (createNewProjectForm);

;// CONCATENATED MODULE: ./src/js/dom/components/newProjectDialog.js
...
function createNewProjectDialog(currentUser) {
    ...
    const newProjectForm = components_newProjectForm(currentUser);
...
function createInbox(currentUser) {
    ...
    inboxIcon.src = inbox_namespaceObject;
...
function handleNewProject(currentUser) {
    ...
    newProjectBtn.addEventListener("click", () => {
        if (
            ...
            const newProjectDialog = components_newProjectDialog(currentUser);
...
class User {
    ...
    #loadLocalStorageProjects() {
        if (!localStorage.getItem("projects")) {
            this.#inbox = new js_project("Inbox");
            ...
            parsedProjects.forEach((project) => {
                const projectWithMethods = new js_project(project.title);
